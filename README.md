...
A **production-ready full stack application** that allows users to **securely upload, manage, and access personal files** using **JWT authentication**, **TOTP-based Two-Factor Authentication (Google Authenticator)**, and **Backup Recovery Codes**.
...
- Update profile details securely
...
⚠️ Note: Backend may experience cold-start delays on free-tier hosting.
...
Sanjai S
Final Year MSc Computer Science Student
